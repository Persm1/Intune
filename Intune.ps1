...
function Get-AuthToken {
    ...
    $intuneAutomationCredential = Get-AutomationPSCredential -Name "intune automation"
...
(
    ...
    try {
        ...
        #break
        # in case we cannot verify we exit the script to prevent cleanups and losing of .csv files in the blob storage
        Exit
    }
...
$AutomationAccounts = get-AzureRmResource | where {$_.Resourcetype -eq "Microsoft.Automation/AutomationAccounts"}
